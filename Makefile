...
# Template: app
# Command: /anaconda3/bin/qmake -o Makefile OthelloUI.pro -spec macx-clang CONFIG+=x86_64
#############################################################################
...
Makefile: OthelloUI.pro /anaconda3/mkspecs/macx-clang/qmake.conf /anaconda3/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile OthelloUI.pro -spec macx-clang CONFIG+=x86_64
...
distdir: FORCE
	...
	$(COPY_FILE) --parents clickableBt.h gameplay.h logic.h ui_gameplay.h $(DISTDIR)/
